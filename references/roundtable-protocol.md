...
> Standing member details (Anthropic Senior Engineer conditional presence, veto authority) are defined in SKILL.md Phase 1, Step 2. This file covers facilitation tactics only.
